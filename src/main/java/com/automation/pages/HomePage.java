...
import static com.automation.utils.LocatorUtils.getDynamicLocator;
...
public class HomePage {
    ...
    public void selectProductFromHomePage(String productName) {
        getDynamicLocator(productName);
    }
